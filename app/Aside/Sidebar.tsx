...
import { isTransitionAside, toggleSidebar, transformWindow } from '../Redux/Slice/SidebarSlice';
import { RootState } from '../Redux/store';
import Menus from './AsideMenus/Menus';

function Sidebar() {
   const transform = useSelector((state: RootState) => state.SidebarReducer.translateWindow);
   const isTransition = useSelector((state: RootState) => state.SidebarReducer.isTransition);
